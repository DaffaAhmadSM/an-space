					...
					<svg class="h-6 w-6 fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
						{#if showMenu}
							<path
								fill-rule="evenodd"
								clip-rule="evenodd"
								d="M19.293 4.707a1 1 0 010 1.414l-14 14a1 1 0 01-1.414-1.414l14-14a1 1 0 011.414 0z"
							/>
							<path
								fill-rule="evenodd"
								clip-rule="evenodd"
								d="M4.707 4.707a1 1 0 000 1.414l14 14a1 1 0 001.414-1.414l-14-14a1 1 0 00-1.414 0z"
							/>
						{:else}
							<path
								fill-rule="evenodd"
